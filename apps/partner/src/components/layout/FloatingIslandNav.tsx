...
export default function FloatingIslandNav() {
  ...
  return (
    <nav
      ...
      className="hidden md:flex fixed top-4 left-1/2 -translate-x-1/2 z-50 items-center gap-1 bg-zinc-900/85 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl p-1.5"
    >
      {/* Logo */}
