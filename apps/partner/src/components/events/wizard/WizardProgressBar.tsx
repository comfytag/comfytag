          ...
          <div key={step.num} className="flex items-start min-w-0" style={{ flex: idx < STEPS.length - 1 ? '1' : '0 0 auto' }}>
            ...
            <div className="flex flex-col items-center shrink-0">
              <button
                ...
                className={[
                  'w-8 h-8 rounded-full flex items-center justify-center text-xs font-black transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500',
                  active
