...
function CitySelectorModal({ isOpen, onClose, onSelect }: CitySelectorModalProps) {
  ...
  return (
    <>
      <style>{`
        ...
        .__ct_city_selector_item { padding: 14px 0; border-bottom: 1px solid var(--color-border); color: var(--color-text); font-size: 14px; cursor: pointer; transition: color 150ms ease, background 100ms ease; }
        ...
        <div style={{ padding: '0 24px' }}>
          ...
          <div className="__ct_city_selector_list">
            {filteredCities.length > 0 ? (
              ...
              <div style={{ padding: '14px 0', color: 'var(--color-text-muted)', fontSize: '14px' }}>
                No cities found
              </div>
            )}
          </div>
