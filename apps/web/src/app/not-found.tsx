...
export default function NotFound() {
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', background: 'var(--color-bg)', gap: '16px', textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: '22px', fontWeight: 700, color: 'var(--color-text)', margin: 0 }}>Page Took an L</h1>
      <p style={{ fontSize: '14px', color: 'var(--color-text-muted)', margin: 0 }}>This page doesn&apos;t exist or got moved. Happens to the best of us.</p>
      <Link href="/"><Button variant="primary">Back to the Party</Button></Link>
    </div>
  )
}
